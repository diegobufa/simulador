    ...
    switch (generoUsuario){
        ...
        case "hombre":
            ...
            if ( pesoFinal !=="" && alturaEnMetros !==""){
                ...
                let repuestaHombre = "Para Hombre el calculo de IMC es: " + calcularImc + " y tu condicion es: " + clasificacion;        
                document.write(repuestaHombre);
        ...
        case "mujer":
            if ( pesoFinal !=="" && alturaEnMetros !==""){
                ...
                let repuestaMujer = " Para Mujer el  calculo de IMC es: " + calcularImc + " y tu condicion es: " + clasificacion;        
            
                document.write(repuestaMujer);
            }
